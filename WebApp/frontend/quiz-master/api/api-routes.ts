...
const QUIZMASTER_SYSTEM_GET_QUIZ_REPORTS = `${QUIZMASTER_SYSTEM}/quiz_reports`;
const QUIZMASTER_SYSTEM_GET_QUIZ_REPORT = (id: Number) =>
    `${QUIZMASTER_SYSTEM}/quiz_reports/${id}`;
...
export {
    ...
    QUIZMASTER_SYSTEM_GET_QUIZ_REPORT,
    QUIZMASTER_QUIZROOM,
