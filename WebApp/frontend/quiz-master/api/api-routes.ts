...
const QUIZMASTER_ACCOUNT=`${process.env.QUIZMASTER_GATEWAY}/account`
...
const QUIZMASTER_AUTH=`${process.env.QUIZMASTER_GATEWAY}/auth`
...
const QUIZMASTER_MEDIA=`${process.env.QUIZMASTER_GATEWAY}/media`
...
const QUIZMASTER_QUESTION=`${process.env.QUIZMASTER_GATEWAY}/question`
...
const QUIZMASTER_QDIFFICULTY=`${process.env.QUIZMASTER_GATEWAY}/question/difficulty`
...
const QUIZMASTER_QTYPE=`${process.env.QUIZMASTER_GATEWAY}/question/type`
...
const QUIZMASTER_QCATEGORY=`${process.env.QUIZMASTER_GATEWAY}/question/category`
...
const QUIZMASTER_SET=`${process.env.QUIZMASTER_GATEWAY}/set`
