                ...
                <div className="flex  w-full gap-0 h-10 text-white transition-all duration-500  ">
                    <div className="flex justify-between flex-row lg:hidden ">
                        <button
                            ...
                            className="inline-flex items-center justify-center p-3 rounded-md text-gray-400 hover:text-white hover:bg-[#FF7F2A90] focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
                    ...
                    <div className=" flex flex-row rounded-3xl items-center gap-10">
                        ...
                        <div className="hidden lg:block ">
                            <Link href="/home" passHref>
                                <span className="mr-10 text-white hover:border-b-2 p-2 border-[#FF7F2A] font-bold cursor-pointer">
                                    Home
                                </span>
                            </Link>
                            ...
                            <Link href="/contact-us" passHref>
                                <span className="text-white hover:border-b-2 p-2 border-[#FF7F2A] font-bold cursor-pointer">
                                    Contact Us
                                </span>
                            </Link>
                        </div>
                        ...
                        {userInfo ? (
                            <div className="flex justify-between items-center">
                                <Link
                                    ...
                                    href="/dashboard"
                                >
                                    <text className="text-2xl pb-1">+</text>
                                ...
                                >
                                    ...
                                    >
                                        <Link
                                            href="/profile"
                                            className="hover:bg-[#5a5a5a30] flex rounded-md hover:cursor-pointer p-3 text-center"
                                        >
                                            Profile Settings
                                        </Link>
                                        <Link
                                            href="/auth/signout"
                                            className="hover:bg-[#5a5a5a30] flex rounded-md p-3 hover:cursor-pointer text-center"
                                        >
                                            Sign out
                                        </Link>
                                    </Popover.Dropdown>
            ...
            {isOpen && (
                <div className="flex flex-row item-center lg:hidden">
                    <div id="mobile-menu" className="ml-10 mt-3 pt-2 pb-3  ">
                        <Link
                            href={"/home"}
                            className="text-white hover:bg-[#1AC159] hover:text-white block px-3 py-2 rounded-md text-base font-medium cursor-pointer"
                        >
                            Home
                        </Link>
                        <Link
