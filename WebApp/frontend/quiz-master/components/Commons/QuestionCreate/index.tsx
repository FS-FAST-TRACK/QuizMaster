...
export default function QuestionCreate() {
  ...
  const form = useForm<QuestionCreateValues>({
    ...
    validate: {
      ...
      qCategoryId: (value) => (parseInt(value) < 1 ? "Select Category." : null),
      qDifficultyId: (value) =>
        ...
        <div className="flex flex-row flex-wrap md:flex-wrap-0 md:flex-col shrink gap-5 [&>*]:w-[200px]">
          <Select
            ...
            data={categories.map((cat) => {
              return { value: cat.id.toString(), label: cat.qCategoryDesc };
            })}
          ...
          <Select
            ...
            data={difficulties.map((dif) => {
              return { value: dif.id.toString(), label: dif.qDifficultyDesc };
            })}
          ...
          <Select
            ...
            data={types.map((type) => {
              return { value: type.id.toString(), label: type.qTypeDesc };
            })}
